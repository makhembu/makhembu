...
- **AI Systems** — LLM-powered tools for hiring, code review, task management, and threat analysis
- **Cybersecurity** — Threat intel aggregation, detection rules, phishing analysis, anomaly detection, incident correlation
- **Edge Infrastructure** — Cloudflare Workers, HLS streaming proxies, and serverless APIs
- **Developer Tooling** — CLI tools, code review bots, SDKs, and API documentation
- **Fintech** — M-Pesa Daraja integration, payment systems, and market data
